...
def plot_numpy_array():
	...
	# X AXIS
	control_data_array_x = np.genfromtxt('/Users/StellaCotton/Downloads/MJFF-Data/extracted/control_raw_data_10min.csv', usecols= (x_axis), delimiter=',')
	...
	#Y AXIS
	control_data_array_y = np.genfromtxt('/Users/StellaCotton/Downloads/MJFF-Data/extracted/control_raw_data_10min.csv', usecols= (y_axis), delimiter=',')
